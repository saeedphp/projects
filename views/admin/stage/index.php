                                            ...
                                            <td>
                                                <a style="cursor: pointer;" data-toggle="modal"
                                                   data-target="#editModal">
                                                    <i onclick="editStatus(<?= $row['id']; ?>)" class="fa fa-edit"></i>
                                                </a>
                                            </td>
                                            <td>
...
<script>
    ...
    function editStatus(statusId) {
        ...
        var url = 'adminstage/editstage/' + statusId;
        var data = {};
    ...
    function editForm() {
        ...
        $.ajax({
            type: 'POST',
            url: 'adminstage/addstatus/' + editStatusId,
