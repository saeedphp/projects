                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="myform2" class="mt-0" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="url" class="form-control mb-2" id="exampleInputUsername1" placeholder="آدرس">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label style="float: none;width: auto !important;;">کلمات کلیدی</label>
                                            <textarea placeholder="کلمات کلیدی..." name="keyword" class="form-control mb-2">

                                            </textarea>
                                        </div>

                                        <div class="form-group">
                                            <label style="float: none;">توضیحات</label>
                                            <textarea placeholder="توضیحات..." name="description" class="form-control mb-2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="cursor: pointer;" data-toggle="modal" data-target="#editModal">
                                                    <i onclick="editMeta(<?= $row['id']; ?>)" class="fa fa-edit"></i>
                                                </a>
                                            </td>
                                            <td>
...
<script>
    ...
    function editMeta(metaId) {
        ...
        var url = 'adminmetatag/editmeta/' + metaId;
        var data = {};
        ...
        $.post(url, data, function (msg) {
            ...
            $('textarea[name=keyword]').val(msg['keyword']);
    ...
    function editForm(){
        ...
        $.ajax({
            type: 'POST',
            url: 'adminmetatag/addmeta/'+editMetaId,
    ...
    function submitForm(){
        ...
        $.ajax({
            type: 'POST',
            url: 'adminprogress/addtech/<?php $projectInfo['id']; ?>',
            ...
            success: function (msg) {
                ...
                $(".x").load('adminprogress/tech/<?= $projectInfo['id']; ?>' + " .x");
            }
        });
