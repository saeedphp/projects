                    ...
                    <div class="widget-header">
                        <div class="row col-12">
                            <div class="col-xl-4 col-md-4 col-sm-12">
                                <h4>مدیریت شبکه های اجتماعی</h4>
                            </div>
                            <div class="col-xl-4 col-md-4 col-sm-12">

                            </div>
                            <div class="col-xl-4 col-md-4 col-sm-12" style="display: flex;justify-content: flex-end;">
                                <button <?php if ($level!=5){echo 'onclick="deleteSocial();"';} ?> <?php if ($level==5){echo 'disabled';} ?> type="button" class="btn btn-danger mb-2 mr-2" data-toggle="modal" data-target="#profileModal">
                                    حذف
                                </button>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="cursor: pointer;" data-toggle="modal" data-target="#editModal">
                                                    <i onclick="editSocial(<?= $row['id']; ?>)" class="fa fa-edit"></i>
                                                </a>
                                            </td>
                                            <td>
...
<script>
    ...
    function editSocial(socialId) {
        ...
        editSocialId = socialId;

        var url = 'adminsocial/editsocial/' + socialId;
        var data = {};
    ...
    function editForm(){
        ...
        $.ajax({
            type: 'POST',
            url: 'adminsocial/addsocial/'+editSocialId,
