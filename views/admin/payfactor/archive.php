                    ...
                    <div class="widget-header">
                        <div class="row col-12">
                            <div class="col-xl-4 col-md-4 col-sm-12">
                                <h4>بایگانی فاکتور ها</h4>
                            </div>
                            <div class="col-xl-4 col-md-4 col-sm-12">

                            </div>
                            <div class="col-xl-4 col-md-4 col-sm-12" style="display: flex;justify-content: flex-end;">
                                <button type="button" id="btn-submit" class="btn btn-success mb-2 mr-2" onclick="recovery();">
                                    بازگردانی
                                </button>
                            </div>
                    ...
                    if (isConfirm) {
                        $.ajax({
                            ...
                            success: function (msg) {
                                ...
                                $(".x").load('adminpayfactor/recovery' + " .x");
                            }
                        });
                    }
                }
