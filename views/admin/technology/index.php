                    ...
                    <div class="widget-header">
                        <div class="row col-12">
                            <div class="col-xl-4 col-md-4 col-sm-12">
                                <h4>مدیریت تکنولوژی های سایت</h4>
                            </div>
                            <div class="col-xl-4 col-md-4 col-sm-12">
                            ...
                            <div class="col-xl-4 col-md-4 col-sm-12" style="display: flex;justify-content: flex-end;">
                                <button <?php if ($level != 5) {
                                    echo 'onclick="deleteStatus();"';
                                } ?> <?php if ($level == 5) {
                                    echo 'disabled';
                                } ?> type="button" class="btn btn-danger mb-2 mr-2" data-toggle="modal"
                                    ...
                                    <form id="myform" class="mt-0" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control mb-2"
                                                   id="exampleInputUsername1" placeholder="عنوان پروژه">
                                        </div>
                                            ...
                                            <td>
                                                <a style="cursor: pointer;" data-toggle="modal"
                                                   data-target="#editModal">
                                                    <i onclick="editTech(<?= $row['id']; ?>)" class="fa fa-edit"></i>
                                                </a>
                                            </td>
                                            <td>
...
<script>
    ...
    function editTech(techId) {
        ...
        var url = 'admintechnology/edittech/' + techId;
        var data = {};
    ...
    function editForm() {
        ...
        $.ajax({
            type: 'POST',
            url: 'admintechnology/edittech/' + editTechId,
