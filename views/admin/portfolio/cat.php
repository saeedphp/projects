                    ...
                    <div class="widget-header">
                        <div class="row col-12">
                            <div class="col-xl-4 col-md-4 col-sm-12">
                                <h4>مدیریت دسته بندی نمونه کار ها</h4>
                            </div>
                            <div class="col-xl-4 col-md-4 col-sm-12">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="cursor: pointer;" data-toggle="modal" data-target="#editModal">
                                                    <i onclick="editCat(<?= $row['id']; ?>)" class="fa fa-edit"></i>
                                                </a>
                                            </td>
                                            <td>
...
<script>
    ...
    function editCat(catId) {
        ...
        var url = 'adminportfolio/editcat/' + catId;
        var data = {};
    ...
    function editForm(){
        ...
        $.ajax({
            type: 'POST',
            url: 'adminportfolio/addcat/'+editCatId,
