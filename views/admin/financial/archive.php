                    ...
                    <div class="widget-header">
                        <div class="row col-12">
                            <div class="col-xl-6 col-md-6 col-sm-12">
                                <h4 style="float: right;">مدیریت مالی پروژه های بایگانی شده</h4>
                            ...
                            <div class="col-xl-6 col-md-6 col-sm-12" style="display: flex;justify-content: flex-end;">
                                <button <?php if ($level!=5){echo 'onclick="deleteFinance();"';} ?> <?php if ($level==5){echo 'disabled';} ?> type="button" class="btn btn-danger mb-2 mr-2" data-toggle="modal" data-target="#profileModal">
                                    حذف
                                </button>
                    ...
                    if (isConfirm){
                        $.ajax({
                            ...
                            success: function(msg) {
                                ...
                                $(".x").load('adminfinancial/archive' + " .x");
                            }
                        });
                    }
                }
