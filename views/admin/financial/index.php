                    ...
                    <div class="widget-header">
                        <div class="row col-12">
                            ...
                            <div class="col-xl-6 col-md-6 col-sm-12" style="display: flex;justify-content: flex-end;">
                                ...
                                } ?> type="button" class="btn btn-warning mb-2 mr-2" data-toggle="modal"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span style="padding: 5px 10px;"
                                                      class="shadow-none <?php if ($row['status'] == 1) {
                                                          echo 'badge-paid';
                                                      } elseif ($row['status'] == 2) {
                                                          echo 'badge-wait';
                                                      } elseif ($row['status'] == 3) {
                                                          echo 'badge-postponed';
                                                      } ?>">
                                                    <?= $row['projectStatus']; ?>
                                                </span>
                                            </td>
                                            ...
                                            <?php } ?>
                                            <td>
                                                <a href="adminfinancial/addfinancial/<?= $row['id']; ?>"
...
<script>
    ...
    function editQuick(financialId) {

        editFinancialId = financialId;

        var url = 'adminfinancial/editfinancial/' + financialId;
        var data = {};

        $.post(url, data, function (msg) {

            $('select[name=project]').val(msg['projectTitle']);
    ...
    function editForm() {
        ...
        $.ajax({
            type: 'POST',
            url: 'adminfinancial/addfinancial/' + editFinancialId,
